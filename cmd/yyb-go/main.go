...
func main() {
	...
	cfg := httpapi.Config{
		...
		OAuthUpstreamURL:       os.Getenv("YYB_OAUTH_UPSTREAM_URL"),
		OAuthUpstreamAPIKey:    os.Getenv("YYB_OAUTH_UPSTREAM_API_KEY"),
		OAuthUpstreamOpenID:    os.Getenv("YYB_OAUTH_UPSTREAM_OPENID"),
		OAuthUpstreamOpenIDMap: os.Getenv("YYB_OAUTH_UPSTREAM_OPENID_MAP"),
	}
